...
/// Public machine facade for typed command/action dispatch and timeline access.
class UnrouterMachine<R extends RouteData> {
  ...
  /// Untyped variant of [dispatchActionEnvelope].
