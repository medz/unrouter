...
void main() {
  ...
  test('runtime binding is driven by core controller runtime', () {
    ...
    expect(
      pubspec.contains('nocterm_router:'),
      isFalse,
      reason: 'nocterm_unrouter should not depend on a framework router shim.',
    );
    expect(
    ...
    expect(runtime.contains('child: Builder('), isTrue);
